                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-footer-widget">
                        ...
                        <div class="single-tweet">
                            <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i> With the popularity of podcast shows growing with each year, you might consider starting it yourself as well.</a>
                    ...
                    <div class="copywrite-content h-100 d-flex align-items-center justify-content-between">
                        ...
                        <div class="copywrite-text">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Customized By <a href="http://rarobi.github.io" target="_blank">Prothomrobi</a>
