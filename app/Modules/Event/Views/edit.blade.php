...
@section('content')
    {{ html()->form('PATCH', route('event.update', $event->id))->attribute('enctype','multipart/form-data')->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">Event List <small class="text-muted">Edit Event</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->textarea('details', $event->description)
                                ->attribute('rows', 5)
                                ->class('form-control')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div>
                                @if($event->image)
                                <img src="/uploads/event_photo/{{ $event->image }}" id="profilePhotoViewer" width="150" height="150" class="img img-responsive img-thumbnail" style="border-radius: 10px;">
                                @else
