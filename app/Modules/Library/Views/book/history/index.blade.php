            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="card-title mb-0">
                        Library Management <small class="text-muted">Member Books Borrow History</small>
                    </h4>
                </div><!--col-->
            </div>
            <hr/>
                ...
                <div class="col">
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-sm table-stripped">
                            <thead>
                            <tr class="@if($record['is_returned']) alert alert-success @else alert alert-danger @endif">
                                <td colspan="6">
