...
{{--                                    <td>{!! $announcement->created_at !!}</td>--}}
                                    <td>
                                        <form  action="{{ route('announcement.destroy',$announcement->id) }}" method="post">
                                            @method('DELETE')
                                            {!! csrf_field() !!}
                                            <a href="{{ route('announcement.edit',$announcement->id) }}" class="btn btn-sm btn-info"title="Edit"><i class="fa fa-edit"></i></a>
        ...
        <div class="modal fade" id="categoryForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    {{ html()->form('POST', route('announcement.store'))->class('form-horizontal')->open() }}
