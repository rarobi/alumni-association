            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                        <a href="{!! route('certification.create') !!}" class="btn btn-success ml-1" data-toggle="tooltip" title="@lang('labels.general.create_new')"><i class="fas fa-plus-circle"></i></a>
                    </div><!--btn-toolbar-->
                </div><!--col-->
            </div><!--row-->
                        ...
                        <table class="table">
                            ...
                            @foreach($certifications as $certification)
                                <tr>
                                    ...
                                    <td> {!! $certification->job_place !!}
                                    </td>
                                    <td>@if($certification->image)
                                            <img src="/uploads/certification_photo/{{ $certification->image }}" height="50" width="100">
                                        @else
                                            N/A
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <form  action="{{ route('certification.destroy',$certification->id) }}" method="post">
                                            @method('DELETE')
                                            {!! csrf_field() !!}
                                            <a href="{{ route('certification.edit',$certification->id) }}" class="btn btn-sm btn-info"title="Edit"><i class="fa fa-edit"></i></a>
