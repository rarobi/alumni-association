...
@section('content')
    {{ html()->form('POST', route('certification.store'))->attribute('enctype','multipart/form-data')->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">Certification List <small class="text-muted">Create Certification</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
            ...
            <div class="row mt-4 mb-4">
                <div class="col">
                    ...
                    <div class="form-group row">
                        {{ html()->label('Company')->class('col-md-2 form-control-label required')->for('company') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label('Quotes')->class('col-md-2 form-control-label required')->for('details') }}
                    ...
                    <div class="form-group row">
                        {{ html()->label('Photo')->class('col-md-2 form-control-label')->for('image') }}
                        <div class="col-md-10">
